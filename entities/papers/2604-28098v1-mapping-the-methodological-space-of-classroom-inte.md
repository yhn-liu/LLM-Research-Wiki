...
- **作者:** Dorottya Demszky, Edith Bouton, Alison Twiner et al. (5 authors)
- **发布日期:** 2026-04-30
...
课堂互动的研究长期以来分为大规模观察和深入的民族志工作。我们提出了一个框架，沿着三个维度——规模、持续时间和模式——映射这个方法论空间，其中研究的立场决定了它所揭示和掩盖的内容。我们通过对话教学的对比研究来说明这一点——Howe 等人。 （2019）和 Snell 和 Lefstein（2018）——以及对主要研究人员的采访，围绕三个问题组织：什么可以操作，什么机制变得可见，以及什么可以转化为实践。然后我们研究人工智能如何扩展这个空间以及该框架如何指导研究和工具设计。
